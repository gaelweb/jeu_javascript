function startGame(){
    ...
    function preLoadPics(){
        cadre = loadImage('images/cadre.png',onloadALL);
        anneauPetit = loadImage('images/anneau_petit.png', onloadALL);
        anneauGrand = loadImage('images/anneau_grand.png',onloadALL);
    }
    preLoadPics();
    ...
    canvas.addEventListener('mousedown',function(e){
        ...
        canvas.addEventListener('mouseup', function mouseUp(e){
            ...
            if(dropChoix(zoneChoix1)){
                ...
                setTimeout(initializePointCorde,1000);
                drawLevel();
            }
